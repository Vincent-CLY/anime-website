        ...
        <nav>
                <div class="title" onclick='hswitch()'>
                    <form id="Username" method='post'>
                        <input type='hidden' id='YourName' name='YourName' value="<?php session_start(); echo $_SESSION['name'];?>"></input>
                        YAHHHHANIMETK
                    </form>
                </div>
